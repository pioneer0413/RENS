...
python evaluation_exp16.py -d cifar10 -n uniform -c 5 --trim 0.01 -e 1000 $early $lr --username mwkim --memo "synthesize.py correction ver."

python evaluation_exp16.py -d cifar10 -n poisson -c 5 --trim 0.01 -e 1000 $early $lr --username mwkim --memo "synthesize.py correction ver."
